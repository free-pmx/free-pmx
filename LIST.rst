...
-  | `free-pmx-no-subscription for Proxmox VE/BS/MG <https://free-pmx.pages.dev/tools/free-pmx-no-subscription/>`__ - *Created 01 Apr 2025* - *Updated 11 Apr 2025*
   | No more post-install chores or nags. Sets up Proxmox original no-subscription repositories, removes the pesky nag of “No-subscription” notice and more. Supports: Proxmox Virtual Environment, Backup Server, Mail Gateway

-  | `A neater Proxmox no subscription setup <https://free-pmx.pages.dev/insights/no-subscription/>`__ - *Created 26 Mar 2025* - *Updated 11 Apr 2025*
...
-  | `Why Proxmox offer full feature set for free <https://free-pmx.pages.dev/insights/cost-free/>`__ - *Created 28 Dec 2024* - *Updated 11 Apr 2025*
