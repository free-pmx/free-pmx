...
-  | `Upgrades and repositories <https://free-pmx.org/guides/apt-update/>`__ - *Last updated 11 Apr 2025*
...
-  | `Proxmox VE nag removal, scripted <https://free-pmx.org/guides/pve-nag-script/>`__ - *Last updated 11 Apr 2025*
...
-  | `DHCP setup of a single node <https://free-pmx.org/guides/dhcp-single/>`__ - *Last updated 14 Dec 2024*
...
-  | `DHCP setup of a cluster <https://free-pmx.org/guides/dhcp-cluster/>`__ - *Last updated 24 Nov 2024*
...
-  | `Proxmox VE nag removal, manually <https://free-pmx.org/guides/pve-nag/>`__ - *Last updated 23 Nov 2024*
